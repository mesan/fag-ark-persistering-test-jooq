...
public class RewardsReport extends TableImpl<RewardsReportRecord> {
	...
	private static final long serialVersionUID = 230037799;
	 ...
	 */
	public final TableField<RewardsReportRecord, Integer> CUSTOMER_ID = createField("customer_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "");
	 ...
	 */
	public final TableField<RewardsReportRecord, Boolean> ACTIVEBOOL = createField("activebool", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>public.rewards_report.create_date</code>.
	 */
	public final TableField<RewardsReportRecord, Date> CREATE_DATE = createField("create_date", org.jooq.impl.SQLDataType.DATE.nullable(false).defaulted(true), this, "");

	/**
	 * The column <code>public.rewards_report.last_update</code>.
	 */
	public final TableField<RewardsReportRecord, Timestamp> LAST_UPDATE = createField("last_update", org.jooq.impl.SQLDataType.TIMESTAMP.defaulted(true), this, "");
