...
public class Film extends TableImpl<FilmRecord> {
	...
	private static final long serialVersionUID = 468894449;
	 ...
	 */
	public final TableField<FilmRecord, Integer> RENTAL_DURATION = createField("rental_duration", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "");
	 ...
	 */
	public final TableField<FilmRecord, MpaaRating> RATING = createField("rating", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(no.mesan.ark.persistering.generated.enums.MpaaRating.class), this, "");
