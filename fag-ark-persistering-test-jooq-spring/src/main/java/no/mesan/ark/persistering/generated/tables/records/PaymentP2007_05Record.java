...
@Entity
@Table(name = "payment_p2007_05", schema = "public")
public class PaymentP2007_05Record extends TableRecordImpl<PaymentP2007_05Record> implements Record6<Integer, Integer, Integer, Integer, BigDecimal, Timestamp> {

	private static final long serialVersionUID = -153343062;
	 ...
	 */
	@Override
	public PaymentP2007_05Record values(Integer value1, Integer value2, Integer value3, Integer value4, BigDecimal value5, Timestamp value6) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public PaymentP2007_05Record(Integer paymentId, Integer customerId, Integer staffId, Integer rentalId, BigDecimal amount, Timestamp paymentDate) {
		super(PaymentP2007_05.PAYMENT_P2007_05);
