...
public class PaymentP2007_03 extends TableImpl<PaymentP2007_03Record> {
	...
	private static final long serialVersionUID = -1959060706;
	 ...
	 */
	public final TableField<PaymentP2007_03Record, Integer> PAYMENT_ID = createField("payment_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), this, "");
	 ...
	 */
	public final TableField<PaymentP2007_03Record, BigDecimal> AMOUNT = createField("amount", org.jooq.impl.SQLDataType.NUMERIC.precision(5, 2).nullable(false), this, "");
	...
	private PaymentP2007_03(String alias, Table<PaymentP2007_03Record> aliased) {
		this(alias, aliased, null);
	}

	private PaymentP2007_03(String alias, Table<PaymentP2007_03Record> aliased, Field<?>[] parameters) {
