...
import no.mesan.ark.persistering.generated.tables.records.AddressRecord;
...
import no.mesan.ark.persistering.generated.tables.records.CustomerRecord;
...
import no.mesan.ark.persistering.generated.tables.records.PaymentP2007_01Record;
import no.mesan.ark.persistering.generated.tables.records.PaymentP2007_02Record;
import no.mesan.ark.persistering.generated.tables.records.PaymentP2007_03Record;
import no.mesan.ark.persistering.generated.tables.records.PaymentP2007_04Record;
import no.mesan.ark.persistering.generated.tables.records.PaymentP2007_05Record;
import no.mesan.ark.persistering.generated.tables.records.PaymentP2007_06Record;
...
import no.mesan.ark.persistering.generated.tables.records.RewardsReportRecord;
...
public class Keys {
	...
	private static class ForeignKeys0 extends AbstractKeys {
		public static final ForeignKey<AddressRecord, CityRecord> ADDRESS__ADDRESS_CITY_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.CITY_PKEY, Address.ADDRESS, Address.ADDRESS.CITY_ID);
		public static final ForeignKey<CityRecord, CountryRecord> CITY__CITY_COUNTRY_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.COUNTRY_PKEY, City.CITY, City.CITY.COUNTRY_ID);
		public static final ForeignKey<CustomerRecord, StoreRecord> CUSTOMER__CUSTOMER_STORE_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.STORE_PKEY, Customer.CUSTOMER, Customer.CUSTOMER.STORE_ID);
		public static final ForeignKey<CustomerRecord, AddressRecord> CUSTOMER__CUSTOMER_ADDRESS_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.ADDRESS_PKEY, Customer.CUSTOMER, Customer.CUSTOMER.ADDRESS_ID);
		public static final ForeignKey<FilmRecord, LanguageRecord> FILM__FILM_LANGUAGE_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.LANGUAGE_PKEY, Film.FILM, Film.FILM.LANGUAGE_ID);
		public static final ForeignKey<FilmRecord, LanguageRecord> FILM__FILM_ORIGINAL_LANGUAGE_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.LANGUAGE_PKEY, Film.FILM, Film.FILM.ORIGINAL_LANGUAGE_ID);
		public static final ForeignKey<FilmActorRecord, ActorRecord> FILM_ACTOR__FILM_ACTOR_ACTOR_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.ACTOR_PKEY, FilmActor.FILM_ACTOR, FilmActor.FILM_ACTOR.ACTOR_ID);
		public static final ForeignKey<FilmActorRecord, FilmRecord> FILM_ACTOR__FILM_ACTOR_FILM_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.FILM_PKEY, FilmActor.FILM_ACTOR, FilmActor.FILM_ACTOR.FILM_ID);
		public static final ForeignKey<FilmCategoryRecord, FilmRecord> FILM_CATEGORY__FILM_CATEGORY_FILM_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.FILM_PKEY, FilmCategory.FILM_CATEGORY, FilmCategory.FILM_CATEGORY.FILM_ID);
		public static final ForeignKey<FilmCategoryRecord, CategoryRecord> FILM_CATEGORY__FILM_CATEGORY_CATEGORY_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.CATEGORY_PKEY, FilmCategory.FILM_CATEGORY, FilmCategory.FILM_CATEGORY.CATEGORY_ID);
		public static final ForeignKey<InventoryRecord, FilmRecord> INVENTORY__INVENTORY_FILM_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.FILM_PKEY, Inventory.INVENTORY, Inventory.INVENTORY.FILM_ID);
		public static final ForeignKey<InventoryRecord, StoreRecord> INVENTORY__INVENTORY_STORE_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.STORE_PKEY, Inventory.INVENTORY, Inventory.INVENTORY.STORE_ID);
		public static final ForeignKey<PaymentRecord, CustomerRecord> PAYMENT__PAYMENT_CUSTOMER_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.CUSTOMER_PKEY, Payment.PAYMENT, Payment.PAYMENT.CUSTOMER_ID);
		public static final ForeignKey<PaymentRecord, StaffRecord> PAYMENT__PAYMENT_STAFF_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.STAFF_PKEY, Payment.PAYMENT, Payment.PAYMENT.STAFF_ID);
		public static final ForeignKey<PaymentRecord, RentalRecord> PAYMENT__PAYMENT_RENTAL_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.RENTAL_PKEY, Payment.PAYMENT, Payment.PAYMENT.RENTAL_ID);
		public static final ForeignKey<PaymentP2007_01Record, CustomerRecord> PAYMENT_P2007_01__PAYMENT_P2007_01_CUSTOMER_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.CUSTOMER_PKEY, PaymentP2007_01.PAYMENT_P2007_01, PaymentP2007_01.PAYMENT_P2007_01.CUSTOMER_ID);
		public static final ForeignKey<PaymentP2007_01Record, StaffRecord> PAYMENT_P2007_01__PAYMENT_P2007_01_STAFF_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.STAFF_PKEY, PaymentP2007_01.PAYMENT_P2007_01, PaymentP2007_01.PAYMENT_P2007_01.STAFF_ID);
		public static final ForeignKey<PaymentP2007_01Record, RentalRecord> PAYMENT_P2007_01__PAYMENT_P2007_01_RENTAL_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.RENTAL_PKEY, PaymentP2007_01.PAYMENT_P2007_01, PaymentP2007_01.PAYMENT_P2007_01.RENTAL_ID);
		public static final ForeignKey<PaymentP2007_02Record, CustomerRecord> PAYMENT_P2007_02__PAYMENT_P2007_02_CUSTOMER_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.CUSTOMER_PKEY, PaymentP2007_02.PAYMENT_P2007_02, PaymentP2007_02.PAYMENT_P2007_02.CUSTOMER_ID);
		public static final ForeignKey<PaymentP2007_02Record, StaffRecord> PAYMENT_P2007_02__PAYMENT_P2007_02_STAFF_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.STAFF_PKEY, PaymentP2007_02.PAYMENT_P2007_02, PaymentP2007_02.PAYMENT_P2007_02.STAFF_ID);
		public static final ForeignKey<PaymentP2007_02Record, RentalRecord> PAYMENT_P2007_02__PAYMENT_P2007_02_RENTAL_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.RENTAL_PKEY, PaymentP2007_02.PAYMENT_P2007_02, PaymentP2007_02.PAYMENT_P2007_02.RENTAL_ID);
		public static final ForeignKey<PaymentP2007_03Record, CustomerRecord> PAYMENT_P2007_03__PAYMENT_P2007_03_CUSTOMER_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.CUSTOMER_PKEY, PaymentP2007_03.PAYMENT_P2007_03, PaymentP2007_03.PAYMENT_P2007_03.CUSTOMER_ID);
		public static final ForeignKey<PaymentP2007_03Record, StaffRecord> PAYMENT_P2007_03__PAYMENT_P2007_03_STAFF_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.STAFF_PKEY, PaymentP2007_03.PAYMENT_P2007_03, PaymentP2007_03.PAYMENT_P2007_03.STAFF_ID);
		public static final ForeignKey<PaymentP2007_03Record, RentalRecord> PAYMENT_P2007_03__PAYMENT_P2007_03_RENTAL_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.RENTAL_PKEY, PaymentP2007_03.PAYMENT_P2007_03, PaymentP2007_03.PAYMENT_P2007_03.RENTAL_ID);
		public static final ForeignKey<PaymentP2007_04Record, CustomerRecord> PAYMENT_P2007_04__PAYMENT_P2007_04_CUSTOMER_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.CUSTOMER_PKEY, PaymentP2007_04.PAYMENT_P2007_04, PaymentP2007_04.PAYMENT_P2007_04.CUSTOMER_ID);
		public static final ForeignKey<PaymentP2007_04Record, StaffRecord> PAYMENT_P2007_04__PAYMENT_P2007_04_STAFF_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.STAFF_PKEY, PaymentP2007_04.PAYMENT_P2007_04, PaymentP2007_04.PAYMENT_P2007_04.STAFF_ID);
		public static final ForeignKey<PaymentP2007_04Record, RentalRecord> PAYMENT_P2007_04__PAYMENT_P2007_04_RENTAL_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.RENTAL_PKEY, PaymentP2007_04.PAYMENT_P2007_04, PaymentP2007_04.PAYMENT_P2007_04.RENTAL_ID);
		public static final ForeignKey<PaymentP2007_05Record, CustomerRecord> PAYMENT_P2007_05__PAYMENT_P2007_05_CUSTOMER_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.CUSTOMER_PKEY, PaymentP2007_05.PAYMENT_P2007_05, PaymentP2007_05.PAYMENT_P2007_05.CUSTOMER_ID);
		public static final ForeignKey<PaymentP2007_05Record, StaffRecord> PAYMENT_P2007_05__PAYMENT_P2007_05_STAFF_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.STAFF_PKEY, PaymentP2007_05.PAYMENT_P2007_05, PaymentP2007_05.PAYMENT_P2007_05.STAFF_ID);
		public static final ForeignKey<PaymentP2007_05Record, RentalRecord> PAYMENT_P2007_05__PAYMENT_P2007_05_RENTAL_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.RENTAL_PKEY, PaymentP2007_05.PAYMENT_P2007_05, PaymentP2007_05.PAYMENT_P2007_05.RENTAL_ID);
		public static final ForeignKey<PaymentP2007_06Record, CustomerRecord> PAYMENT_P2007_06__PAYMENT_P2007_06_CUSTOMER_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.CUSTOMER_PKEY, PaymentP2007_06.PAYMENT_P2007_06, PaymentP2007_06.PAYMENT_P2007_06.CUSTOMER_ID);
		public static final ForeignKey<PaymentP2007_06Record, StaffRecord> PAYMENT_P2007_06__PAYMENT_P2007_06_STAFF_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.STAFF_PKEY, PaymentP2007_06.PAYMENT_P2007_06, PaymentP2007_06.PAYMENT_P2007_06.STAFF_ID);
		public static final ForeignKey<PaymentP2007_06Record, RentalRecord> PAYMENT_P2007_06__PAYMENT_P2007_06_RENTAL_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.RENTAL_PKEY, PaymentP2007_06.PAYMENT_P2007_06, PaymentP2007_06.PAYMENT_P2007_06.RENTAL_ID);
		public static final ForeignKey<RentalRecord, InventoryRecord> RENTAL__RENTAL_INVENTORY_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.INVENTORY_PKEY, Rental.RENTAL, Rental.RENTAL.INVENTORY_ID);
		public static final ForeignKey<RentalRecord, CustomerRecord> RENTAL__RENTAL_CUSTOMER_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.CUSTOMER_PKEY, Rental.RENTAL, Rental.RENTAL.CUSTOMER_ID);
		public static final ForeignKey<RentalRecord, StaffRecord> RENTAL__RENTAL_STAFF_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.STAFF_PKEY, Rental.RENTAL, Rental.RENTAL.STAFF_ID);
		public static final ForeignKey<StaffRecord, AddressRecord> STAFF__STAFF_ADDRESS_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.ADDRESS_PKEY, Staff.STAFF, Staff.STAFF.ADDRESS_ID);
		public static final ForeignKey<StaffRecord, StoreRecord> STAFF__STAFF_STORE_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.STORE_PKEY, Staff.STAFF, Staff.STAFF.STORE_ID);
		public static final ForeignKey<StoreRecord, StaffRecord> STORE__STORE_MANAGER_STAFF_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.STAFF_PKEY, Store.STORE, Store.STORE.MANAGER_STAFF_ID);
		public static final ForeignKey<StoreRecord, AddressRecord> STORE__STORE_ADDRESS_ID_FKEY = createForeignKey(no.mesan.ark.persistering.generated.Keys.ADDRESS_PKEY, Store.STORE, Store.STORE.ADDRESS_ID);
	}
}
